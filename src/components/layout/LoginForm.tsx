...
export function LoginForm({
  ...
  const { mutate: login, isPending } = useLogin(onLoggedIn);
    ...
    >
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <div className="p-6 md:p-8 text-right">
            <div className="flex flex-col items-center gap-2 text-center mb-7">
              ...
              <p className="mt-2 max-w-sm text-sm leading-6 text-muted-foreground">
                برای ورود به ابراز پلاس رمز عبور شما (در صورت عدم تغییر توسط
                خودتان) کد ملی شما می‌باشد.
              </p>
            </div>
            ...
            >
              ...
              <TabsContent value="password">
                <form className="pt-6" onSubmit={handlePasswordSubmit}>
                  <FieldGroup>
                    <Field>
          ...
          <div className="relative hidden overflow-hidden bg-[#0f3d3e] md:block">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(196,163,90,0.35),transparent_55%)]" />
            <div className="relative flex h-full min-h-[420px] flex-col items-center justify-center gap-3 p-8 text-center text-white">
              <p className="text-sm text-amber-200">کلینیک روانشناسی ابراز</p>
              <h2 className="text-3xl font-bold">ابراز پلاس</h2>
              <p className="max-w-xs text-sm leading-6 text-white/75">
                پنل یکپارچه مراجعان و شرکت‌کنندگان دوره‌ها، کارگاه‌ها و سمینارها
              </p>
            </div>
          </div>
        </CardContent>
